                                            ...
                                            <div className="flex flex-col min-w-0">
                                              <div className="flex items-center gap-1.5">
                                                ...
                                                {(() => {
                                                  ...
                                                  return <Badge className={`text-[10px] px-1.5 py-0 font-medium border-0 ${cls}`}>{label}</Badge>;
                                                })()}
                                              </div>
                                            ...
                                            {inventory
                                              ...
                                              .map((inv) => {
                                                ...
                                                return (
                                                  <CommandItem
                                                    key={key}
                                                    value={`S#${inv.serialNumber} ${placeLabel} ${inv.potatoType} ${inv.size || "Mixed"} ${inv.farmerName} ${inv.farmerVillage || ""} ${displayBags} bags available`}
                                                    onSelect={() => {
