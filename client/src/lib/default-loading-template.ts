export const defaultLoadingTemplate = `<!DOCTYPE html>
<html>
<head>
<style>
...
<div class="page">
  ...
  <table class="buyer-table">
    <tr>
      <td class="buyer-name-cell" rowspan="4"><div style="display:flex;flex-direction:column;height:100%;min-height:90px"><div>{{buyerName}}</div>{{location}}{{buyerContact}}{{purchaseOrder}}</div></td>
