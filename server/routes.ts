      ...
      for (const lotData of data.lots) {
        const lot = await storage.createLot({
          ...
          totalWeight: lotData.cutType === "gate_cut" && lotData.totalWeight 
            ...
            : null,
          charges: lotData.charges && lotData.charges.length > 0 ? roundColdStoreChargeAmounts(lotData.charges) : null,
          ...
          if (lotData.id) {
            ...
            await storage.updateLot(lotData.id, merchantId, {
              ...
              charges: lotData.charges !== undefined
                ? (lotData.charges && lotData.charges.length > 0 ? roundColdStoreChargeAmounts(lotData.charges) : null)
                : undefined,
