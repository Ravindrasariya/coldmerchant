...
- **Profit & Loss**: Auto-generated for selected FY. Revenue from cash inward entries by revenueType. Expenses from cash outflow entries by expenseType (excluding capital_expense, which is a balance sheet transaction — only depreciation represents capital asset cost in P&L) + depreciation + loan interest. Shows net profit/loss.
